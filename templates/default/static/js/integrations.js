	...
	curInst.$loadingContainer.fadeOut( 400, function () {
		if ( 'success' === response['responseType'] ) {
			...
			$.each( response.data, function ( i, profile ) {
				...
				selectHTML += '<option value="' + profile.id.toString() + '" ' + selected + '>' + profile.name.toString() + '</option>';
			} );
...
function Twitter( viewName ) {
	...
	this.historicalDataError = $( '#skystats-twitter-historical-data-notice' );
...
Twitter.prototype.displayDataTabData = function() {
	...
	this.$loadingContainer.fadeOut( 400, function() {
		...
		setDataPointChangeDirectionClass( 'skystats-twitter-tweets-change-direction', curInst.data['period']['tweets_change_direction'] );
		setDataPointChangeClass( 'skystats-twitter-tweets-change', curInst.data['period']['tweets_change_direction'] );
		...
		setDataPointChangeDirectionClass( 'skystats-twitter-following-change-direction', curInst.data['period']['following_change_direction'] );
		setDataPointChangeClass( 'skystats-twitter-following-change', curInst.data['period']['following_change_direction'] );
		...
		setDataPointChangeDirectionClass( 'skystats-twitter-followers-change-direction', curInst.data['period']['followers_change_direction'] );
		setDataPointChangeClass( 'skystats-twitter-followers-change', curInst.data['period']['followers_change_direction'] );
		...
		setDataPointChangeDirectionClass( 'skystats-twitter-retweets-change-direction', curInst.data['period']['retweets_change_direction'] );
		setDataPointChangeClass( 'skystats-twitter-retweets-change', curInst.data['period']['retweets_change_direction'] );
		...
		setDataPointChangeDirectionClass( 'skystats-twitter-favourites-change-direction', curInst.data['period']['favourites_change_direction'] );
		setDataPointChangeClass( 'skystats-twitter-favourites-change', curInst.data['period']['favourites_change_direction'] );
		...
		setDataPointChangeDirectionClass( 'skystats-twitter-mentions-change-direction', curInst.data['period']['mentions_change_direction'] );
		setDataPointChangeClass( 'skystats-twitter-mentions-change', curInst.data['period']['mentions_change_direction'] );
...
function getIntegrations( viewName ) {
	var google = new GoogleAnalytics( viewName ),
		...
		twitter = new Twitter( viewName);

	return [ google, fb, twitter ];
}
