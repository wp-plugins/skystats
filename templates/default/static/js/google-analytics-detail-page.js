/*http://www.jslint.com/*/
/*jslint white: true */
/*global jQuery, window, console, ajaxurl, skystats_google_analytics*/
jQuery( window ).ready( function( $ ) {
	var $pageLoadingContainer = $( '#skystats-page-loading-container' ),
		...
		$dataContainer = $( '#skystats-google-analytics-data-container' );
		...
		if ( 'error' === response.responseType ) {
			switch ( response['responseContext'] ) {
				case 'missing_license_key':
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['missing_license_key'] );
					break;
				case 'license_expired':
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['license_expired'] );
					break;
				case 'malformed_license_key':
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['malformed_license_key'] );
					break;
				case 'http_error':
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['http_error'] );
					break;
				case 'error_initialising_request':
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['error_initializing_request'] );
					break;
				case 'error_executing_request':
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['error_executing_request'] );
					break;
				case 'malformed_response':
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['malformed_request'] );
					break;
				case 'license_site_inactive':
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['license_site_inactive'] );
					break;
				case 'license_site_inactive_no_activations_left':
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['license_site_inactive_no_activations_left'] );
					break;
				case 'license_inactive':
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['license_inactive'] );
					break;
				case 'license_inactive_no_activations_left':
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['license_inactive_no_activations_left'] );
					break;
				case 'license_disabled':
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['license_disabled'] );
					break;
				case 'license_unknown_status':
				default:
					$pageErrorContainerMsg.html( skystats_google_analytics['trans']['licensing']['license_unknown_status'] );
					break;
			}
			...
			$pageLoadingContainer.fadeOut( 400, function() {
				...
				var integration = getIntegration( 'googleAnalytics', 'detail' );
