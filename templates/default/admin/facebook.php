...
<div class="wrap">
	...
	<div id="skystats-date-range-notice-container">
		...
		<p id="skystats-free-data-range-notice" class="skystats-success-message"><?php printf( __( 'Currently displaying the past 30 days. Upgrade to <a href="%s" target="_blank">SkyStats Pro</a> to access more than 30 days of data.', SKYSTATS_TEXT_DOMAIN ), SKYSTATS_MARKETING_SITE_PRICING_SECTION_URL ); ?></p>
	</div>
	...
	<div id="skystats-facebook-data-container" class="skystats-service-detail-container">
		...
		<div id="skystats-detail-chart-key-container" class="skystats-service-detail-chart-key-container">
			<span id="skystats-facebook-likes-chart-key-icon" class="skystats-detail-chart-key-icon">&nbsp;</span>
			<span><?php _e( 'Total Likes', SKYSTATS_TEXT_DOMAIN ); ?></span>
			<span id="skystats-facebook-reach-chart-key-icon" class="skystats-detail-chart-key-icon">&nbsp;</span>
			...
			<div class="skystats-service-detail-data-tables-container">
				...
				<div class="skystats-service-detail-data-table-column skystats-service-detail-full-width-data-table-column">
					<div id="skystats-facebook-top-posts-data-table-column-content" class="skystats-data-table-column-content">
						...
						<div id="skystats-facebook-top-posts-data-error-container" class="skystats-top-data-error-container">
