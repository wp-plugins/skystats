...
<div id="youtube_5" class="skystats-card-container">
	<div id="skystats-google-analytics-card" class="skystats-card">
		<div class="skystats-card-header">
			...
			<h4 class="skystats-card-heading"><?php _e( 'YouTube', SKYSTATS_TEXT_DOMAIN ); ?></h4>
		...
		<div id="skystats-youtube-card-content" class="skystats-card-content">
			<div class="skystats-card-image-container">
				<a href="https://skystats.com/#integrations"><img src="<?php echo SKYSTATS_TEMPLATE_IMAGES_URL . 'youtube.png'; ?>"></a>
			</div>
			<div class="skystats-vote-now-container">
				...
				<div id="skystats-youtube-integration-vote-totals-container" class="skystats-integration-vote-totals-container">
					<strong>0</strong>
					<span><?php _e( 'votes', SKYSTATS_TEXT_DOMAIN ); ?></span>
				</div>
				<a href="" class="skystats-mashboard-vote-now skystats-shadowless" data-integration="youtube">
					<img src="<?php echo SKYSTATS_TEMPLATE_IMAGES_URL . 'vote-now-button.png'; ?>" alt="<?php _e( 'Click to Vote for Youtube', SKYSTATS_TEXT_DOMAIN ); ?>">
				</a>
			</div>
		</div>
	</div>
