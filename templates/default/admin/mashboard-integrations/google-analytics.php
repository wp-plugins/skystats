	...
	<div class="skystats-card">
		...
		<div id="skystats-google-analytics-card-content" class="skystats-card-content">
			...
			<div id="skystats-google-analytics-settings-content">
				...
				<!-- Select a profile -->
				<div id="skystats-google-analytics-settings-profiles-section" class="skystats-google-analytics-settings-tab-section skystats-settings-tab-section" style="display: block; ">
