	...
	<div class="skystats-card">
		...
		<div id="skystats-mailchimp-card-content" class="skystats-card-content">
			<div class="skystats-card-image-container">
				<a href="https://skystats.com/#integrations"><img src="<?php echo SKYSTATS_TEMPLATE_IMAGES_URL . 'mailchimp.png'; ?>"></a>
			</div>
			<div class="skystats-vote-now-container">
				...
				<div id="skystats-mailchimp-integration-vote-totals-container" class="skystats-integration-vote-totals-container">
					<strong>0</strong>
					<span><?php _e( 'votes', SKYSTATS_TEXT_DOMAIN ); ?></span>
				</div>
				<a href="" class="skystats-mashboard-vote-now skystats-shadowless" data-integration="mailchimp">
					<img src="<?php echo SKYSTATS_TEMPLATE_IMAGES_URL . 'vote-now-button.png'; ?>" alt="<?php _e( 'Click to Vote for MailChimp', SKYSTATS_TEXT_DOMAIN ); ?>">
				</a>
			</div>
		</div>
	</div>
