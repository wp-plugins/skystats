...
/**
 * URL to the Twitter detail page.
 *
 * @since 0.2.9
 *
 * @var string
...
/**
 * URL to the settings page which will also make the settings accordion section the active accordion section.
 *
 * @since 0.2.4
 *
 * @var string
 */
define( 'SKYSTATS_SETTINGS_PAGE_SETTINGS_ACTIVE_ACCORDION_SECTION_URL', SKYSTATS_SETTINGS_PAGE_URL . '&amp;active_accordion_section=settings' );
 ...
 * @var string
 */
define( 'SKYSTATS_MARKETING_SITE_FREE_SIGNUP_PAGE_URL', 'https://skystats.com/free-signup/?utm_source=wordpress&utm_medium=plugin&utm_campaign=license#pricing' );
 ...
 * @var string
 */
define( 'SKYSTATS_SCRIPTS_VERSION', 'skystats-free-030-1438702957' );