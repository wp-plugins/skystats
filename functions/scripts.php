 ...
 */
function skystats_enqueue_style( $handle, $filename, array $deps = array(), $version = SKYSTATS_SCRIPTS_VERSION, $media = 'all' ) {
 ...
 * @param string         $media    (Optional) The media type this stylesheet supports.
 */
function skystats_enqueue_minified_style( $handle, $filename, array $deps = array(), $version = SKYSTATS_SCRIPTS_VERSION, $media = 'all' ) {
 ...
 */
function skystats_enqueue_script( $handle, $filename, $deps = array(), $version = SKYSTATS_SCRIPTS_VERSION ) {
	if ( ! SKYSTATS_USE_MINIFIED_SCRIPTS ) {
 ...
 * @param string         $version  (Optional) The version to use for caching the script.
 */
function skystats_enqueue_minified_script( $handle, $filename, $deps = array(), $version = SKYSTATS_SCRIPTS_VERSION ) {
 ...
 * @param string         $version  (Optional) The version to use for caching the script.
 */
function skystats_enqueue_uncompressed_script( $handle, $filename, $deps = array(), $version = SKYSTATS_SCRIPTS_VERSION ) {
