...
function skystats_api_licensing_get_license_status_translations( $current_url ) {
	...
	$translations = array(
		'license_invalid'                           => sprintf( __( 'Sorry, this license key is invalid. Please click <a href="%s">here</a> to check you\'ve entered your license key correctly, or to enter a new one.', SKYSTATS_TEXT_DOMAIN ), SKYSTATS_SETTINGS_PAGE_URL ),
...
function skystats_api_licensing_get_license_validation_request_translations() {
	...
	$pleaseEnterValidLicenseKey = __( 'Please enter a valid license key.', SKYSTATS_TEXT_DOMAIN );

	$translations = array(
		'license_invalid'                           => $pleaseEnterValidLicenseKey,
		'missing_license_key'                       => __( 'Please enter a license key.', SKYSTATS_TEXT_DOMAIN ),
		'malformed_license_key'                     => $pleaseEnterValidLicenseKey,
