...
add_action( 'load-skystats_page_skystats-twitter', 'skystats_load_integration_admin_page' );
...
function skystats_admin_enqueue_mashboard_scripts() {
	...
	$translations = array(
		...
		'voting_not_opted_in_sub_message' => vsprintf( __( 'Sorry, in order to vote you must opt-in to allow us to include your email address in your vote(s). Please click <a href="%s">here</a> to opt-in.', SKYSTATS_TEXT_DOMAIN ), SKYSTATS_SETTINGS_PAGE_SETTINGS_ACTIVE_ACCORDION_SECTION_URL ),
